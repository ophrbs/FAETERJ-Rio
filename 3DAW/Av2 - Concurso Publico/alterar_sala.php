...
<form action="?page=salvar" method="POST">
  ...
  <input disabled type="text" name="nome_candidato" value="<?php print $row->nome_candidato; ?>">
  ...
  <input disabled type="text" name="cpf_candidato" value="<?php print $row->cpf_candidato; ?>">

  <label for="identidade_candidato">Identidade</label>
  <input disabled type="text" name="identidade_candidato" value="<?php print $row->identidade_candidato; ?>">

  <label for="email_candidato">E-mail</label>
  <input disabled type="mail" name="email_candidato" value="<?php print $row->email_candidato; ?>">

  <label for="cargo_candidato">Cargo</label>
  <input disabled type="text" name="cargo_candidato" value="<?php print $row->cargo_candidato; ?>">
